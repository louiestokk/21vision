...
import { ArrowUpRight, Play, Sparkles, Monitor, Smartphone, PenTool, LayoutTemplate, Zap, Code2 } from "lucide-react";
  ...
  return (
    <section id="home" className="relative min-h-screen pt-28 pb-20 md:pt-36 md:pb-32 px-6 md:px-12 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 max-w-[1600px] mx-auto overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-start z-10 w-full">
        ...
        >
          <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white text-black px-8 py-4 rounded-full text-base font-medium hover:scale-105 transition-transform cursor-pointer">
            {t.ourWork} <ArrowUpRight className="w-5 h-5" />
          </button>
          <button className="w-full sm:w-auto flex items-center justify-center gap-3 bg-zinc-900 text-white px-8 py-4 rounded-full text-base font-medium hover:bg-zinc-800 transition-colors cursor-pointer border border-zinc-800">
